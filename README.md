...
Project Leviathan is a fork of both the [VOREStation](https://github.com/VOREStation/VOREStation/) and [Citadel Station 13 RP](https://github.com/Citadel-Station-13/Citadel-Station-13-RP) code branches, for the game Space Station 13.

---

### LICENSE
The code for Project Leviathan is licensed under the [GNU Affero General Public License](http://www.gnu.org/licenses/agpl.html) version 3, which can be found in full in LICENSE-AGPL3.txt.
...
If you are unfamiliar with using git, byond or Space Station 13 code, you may wish to check one of the upstream codebases for support and instruction.
[Polaris](https://github.com/PolarisSS13/Polaris) - [Citadel Station 13 RP](https://github.com/Citadel-Station-13/Citadel-Station-13-RP) - [VOREStation](https://github.com/VOREStation/VOREStation)
