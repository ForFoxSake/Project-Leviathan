...
/datum/shuttle_autopath/shuttle1/to_outpost
	start = /datum/shuttle_destination/shuttle1/docked_SC
...
/datum/shuttle_autopath/shuttle2/to_outpost
	start = /datum/shuttle_destination/shuttle2/docked_SC
...
/datum/shuttle_destination/shuttle1/root
	...
	routes_to_make = list(
		/datum/shuttle_destination/shuttle1/sky = 10 SECONDS,
...
/datum/shuttle_destination/shuttle2/root
	...
	routes_to_make = list(
		/datum/shuttle_destination/shuttle2/sky = 10 SECONDS,
...
/datum/shuttle_destination/shuttle1/sky
	...
	routes_to_make = list(
		/datum/shuttle_destination/shuttle1/docked_SC = 10 SECONDS,
...
/datum/shuttle_destination/shuttle2/sky
	...
	routes_to_make = list(
		/datum/shuttle_destination/shuttle2/docked_SC = 10 SECONDS,
