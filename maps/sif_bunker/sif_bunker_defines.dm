...
/datum/map/sif_bunker
	...
	zlevel_datum_type = /datum/map_z_level/sif_bunker

	station_name  = "NSB Southern Cross"
	...
	default_skybox = /datum/skybox_settings/sif_bunker
...
*/
/datum/map/sif_bunker/perform_map_generation()
...
// Skybox Settings
/datum/skybox_settings/sif_bunker
	icon_state = "dyable"
	random_color = TRUE
...
/datum/map_z_level/sif_bunker/station/station_two
...
/datum/map_z_level/sif_bunker/station/station_three
...
/datum/map_z_level/sif_bunker/empty_space
	z = Z_LEVEL_EMPTY_SPACE
	name = "Empty"
	flags = MAP_LEVEL_PLAYER
	transit_chance = 76

/datum/map_z_level/sif_bunker/surface
	z = Z_LEVEL_SURFACE
	name = "Plains"
	flags = MAP_LEVEL_STATION|MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER|MAP_LEVEL_SEALED|MAP_LEVEL_CONSOLES
	base_turf = /turf/simulated/floor/outdoors/rocks

/datum/map_z_level/sif_bunker/surface_mine
	z = Z_LEVEL_SURFACE_MINE
	name = "Mountains"
	flags = MAP_LEVEL_STATION|MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER|MAP_LEVEL_SEALED|MAP_LEVEL_CONSOLES
	base_turf = /turf/simulated/floor/outdoors/rocks

/datum/map_z_level/sif_bunker/surface_wild
	z = Z_LEVEL_SURFACE_WILD
	name = "Wilderness"
	flags = MAP_LEVEL_PLAYER|MAP_LEVEL_SEALED|MAP_LEVEL_CONTACT|MAP_LEVEL_CONSOLES
	base_turf = /turf/simulated/floor/outdoors/rocks

/datum/map_z_level/sif_bunker/misc
	z = Z_LEVEL_MISC
	name = "Misc"
	flags = MAP_LEVEL_PLAYER
	transit_chance = 6

/datum/map_z_level/sif_bunker/centcom
	z = Z_LEVEL_CENTCOM
	name = "Centcom"
	flags = MAP_LEVEL_ADMIN|MAP_LEVEL_CONTACT

/datum/map_z_level/sif_bunkertransit
	z = Z_LEVEL_TRANSIT
	name = "Transit"
