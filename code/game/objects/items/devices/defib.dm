...
#define DEFIB_TIME_LOSS  (6 MINUTES) //past this many seconds, brain damage occurs.
...
/obj/item/weapon/shockpaddles/proc/can_revive(mob/living/carbon/human/H) //This is checked right before attempting to revive
	...
	//Leviathan Edit: We're gunna need to be able to snap people back to life regardless of if they're playing anyway.
