...
/obj/item/weapon/card/id/gold/captain/spare
	name = "\improper Commanding Officer's spare ID"
...
/obj/item/weapon/card/id/civilian/head //This is not the XO. There's no position that uses this right now.
	name = "identification card"
