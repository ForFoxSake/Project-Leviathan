...
/area/maintenance/substation/command // AI and central cluster. This one will be between XO office and meeting room (probably).
...
/area/crew_quarters/captain
	name = "\improper Command - Commanding Officer's Office"
	icon_state = "captain"
	sound_env = MEDIUM_SOFTFLOOR
...
/area/crew_quarters/heads/hos
	name = "\improper Security - HoO's Office"
	icon_state = "head_quarters"
