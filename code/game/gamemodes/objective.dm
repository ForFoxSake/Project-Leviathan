...
datum/objective/steal
	...
	var/global/possible_items[] = list(
		"the Commanding Officer's antique laser gun" = /obj/item/weapon/gun/energy/captain,
		"a hand teleporter" = /obj/item/weapon/hand_tele,
		"an RCD" = /obj/item/weapon/rcd,
		"a jetpack" = /obj/item/weapon/tank/jetpack,
		"a commanding officer's jumpsuit" = /obj/item/clothing/under/rank/captain,
		...
		"a head of operations' jumpsuit" = /obj/item/clothing/under/rank/head_of_security,
		...
		"the commanding officer's pinpointer" = /obj/item/weapon/pinpointer,
