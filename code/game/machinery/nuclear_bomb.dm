...
/obj/machinery/nuclearbomb/attack_hand(mob/user as mob)
	if(extended)
		...
		var/dat = text("<TT>Auth. Disk: <A href='?src=\ref[];auth=1'>[]</A><HR>", src, (auth ? "++++++++++" : "----------"))
		if(auth)
			if(yes_code)
		...
		var/datum/browser/popup = new(user, "nuclearbomb", "Nuclear Fission Explosive", 300, 400)
...
obj/machinery/nuclearbomb/proc/nukehack_win(mob/user as mob)
	var/dat as text
	dat += "<TT>Nuclear Device Wires:</A><HR>"
