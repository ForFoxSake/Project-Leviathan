...
/obj/machinery/firealarm/attack_hand(mob/user as mob)
	...
	if(istype(user, /mob/living/carbon/human) || istype(user, /mob/living/silicon))
		...
		var/datum/browser/popup = new(user, "firealarm", "Fire Alarm", 300, 200)
		...
		var/datum/browser/popup = new(user, "firealarm", "[stars("Fire Alarm")]", 300, 200)
		popup.set_content(dat)
		popup.open()
		onclose(user, "firealarm")
	return
...
/obj/machinery/partyalarm/attack_hand(mob/user as mob)
	...
	if(istype(user, /mob/living/carbon/human) || istype(user, /mob/living/silicon/ai))
		...
		var/datum/browser/popup = new(user, "partyalarm", "Party Button", 300, 200)
		popup.set_content(dat)
		popup.open()
		...
		var/minute = (time - second) / 60
		var/dat = text("<TT>[]\n<HR>\nTimer System: []<BR>\nTime Left: [][] <A href='?src=\ref[];tp=-30'>-</A> <A href='?src=\ref[];tp=-1'>-</A> <A href='?src=\ref[];tp=1'>+</A> <A href='?src=\ref[];tp=30'>+</A>\n</TT>", d1, d2, (minute ? text("[]:", minute) : null), second, src, src, src, src)
		var/datum/browser/popup = new(user, "partyalarm", stars("Party Button"), 300, 200)
		popup.set_content(dat)
		popup.open()
		onclose(user, "partyalarm")
	return
