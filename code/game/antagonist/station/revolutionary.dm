...
/datum/antagonist/revolutionary
	...
	avoid_silicons = TRUE
	protected_jobs = list("Guard", "Warden", "Detective", "Internal Affairs Agent", "Commanding Officer", "Executive Officer", "Head of Operations", "Chief Engineer", "Research Director", "Chief Medical Officer")
	roundstart_restricted = list("Internal Affairs Agent", "Commanding Officer", "Executive Officer", "Head of Operations", "Chief Engineer", "Research Director", "Chief Medical Officer")
