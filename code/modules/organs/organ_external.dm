...
/obj/item/organ/external/proc/update_wounds()
	...
	for(var/datum/wound/W in wounds)
		...
		if(W.internal && owner.bodytemperature >= 170)
			...
			// Previously, internal bleeding would get progressively worse unless treated, indefinitely.
			if(!((bicardose && inaprovaline) || myeldose)) // Treatment now pauses the bleeding instead.
