...
/datum/category_item/catalogue/information/organization/saare
	name = "Military - Stealth Assault Enterprises"
	datum_to_copy = /datum/lore/organization/mil/saare