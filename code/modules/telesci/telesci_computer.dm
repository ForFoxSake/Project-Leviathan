	...
	switch(rand(99))
		...
		if(91 to 98)
			...
			if(telepad)
				...
				var/list/hostiles = list(/mob/living/simple_mob/humanoid/merc/melee/sword, /mob/living/simple_mob/humanoid/merc/ranged/smg, /mob/living/simple_mob/humanoid/merc/ranged/rifle, /mob/living/simple_mob/humanoid/merc/ranged/laser, /mob/living/simple_mob/humanoid/merc/ranged/ionrifle, /mob/living/simple_mob/humanoid/pirate, /mob/living/simple_mob/humanoid/pirate/ranged, /mob/living/simple_mob/humanoid/russian/ranged, /mob/living/simple_mob/blob/spore/infesting, /mob/living/simple_mob/mechanical/corrupt_maint_drone, /mob/living/simple_mob/mechanical/infectionbot, /mob/living/simple_mob/mechanical/hivebot, /mob/living/simple_mob/mechanical/mecha/combat/gygax/dark/advanced, /mob/living/simple_mob/mechanical/combat_drone, /mob/living/simple_mob/animal/giant_spider/carrier/recursive, /mob/living/simple_mob/animal/space/carp/large)
		...
		if(99)
			...
			spacevine_infestation(pick(list(typesof(/area/hallway), typesof(/area/maintenance), list(get_area(telepad).type))))
			return
