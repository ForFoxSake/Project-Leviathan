...
/obj/item/weapon/gun/projectile/cell_loaded/medical
	...
	healing beams can be configured at once, depending on cartridge used. Ammo not included." // TODO: Fix circular dependancy. The NSFW is based on this, yet this is based on the NSFW? Which is it?
