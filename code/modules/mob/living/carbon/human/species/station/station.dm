...
/datum/species/diona/equip_survival_gear(var/mob/living/carbon/human/H)
	if(H.backbag == 1)
		H.equip_to_slot_or_del(new /obj/item/device/lighting/flare(H), slot_r_hand)
	else
		H.equip_to_slot_or_del(new /obj/item/device/lighting/flare(H.back), slot_in_backpack)
