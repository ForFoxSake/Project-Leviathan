...
/mob/living/simple_mob/animal/passive/fox/renault
	name = "Renault"
	desc = "Renault, the Commanding Officer's trustworthy fox. I wonder what it says?"
	tt_desc = "Vulpes nobilis"
	//befriend_job = "Commanding Officer" Sebbe edit: couldn't make this work, commenting out for now.
