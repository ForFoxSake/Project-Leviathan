/datum/computer_file/program/scanner
	...
	usage_flags = PROGRAM_TABLET | PROGRAM_PDA
	...
	var/scan_file_type = "TXT"		//The type of file the data will be saved to.
...
/datum/nano_module/program/scanner/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1, var/datum/topic_state/state = default_state)
