/datum/lore/codex/category/corporate_regulations
	...
	All NanoTrasen employees must follow these regulations, no one is above them, not even the Commanding Officer.  \
...
/datum/lore/codex/page/corporate_punishments
	...
	<li><b>Reassignments</b> as a form of punishment may be done by the Commanding Officer, with consent from both the offender and the offender's \
	...
	<li><b>Demotions</b> may be done by the offender's Superior, at their discretion.  The Commanding Officer may also do this, \
	however the Director is recommended to defer to the offender's direct Superior if one exists.</li><br>\
	<li><b>Terminations of employment</b> from NanoTrasen can only be issued by the Commanding Officer.  This is the most severe corporate punishment available. \
	...
	<li><b>Hold until Transfer</b> is an option reserved for the Commanding Officer only for repeat offenders, for serious violations of Regulations, or it the offender poses a \
...
/datum/lore/codex/page/law/i_am_the_law/add_content()
	...
	suggested_punishments = "Demotion or termination at discretion of Station Admin.  Send notice to Central Command if a Head of Staff or Commanding Officer had exceeded their powers."
...
/datum/lore/codex/page/law/abuse_of_office/add_content()
	...
	suggested_punishments = "Demotion.  Termination at discretion of Station Admin.  Send notice to Central Command if a Head of Staff or Commanding Officer had abused their office."
...
/datum/lore/codex/page/law/restricted_contraband
	...
	<br><br>\
	Roles authorized to handle a weapon by default include; Commanding Officer, Executive Officer, Head of Operations, Guards, Detectives, and anyone possessing \
...
/datum/lore/codex/page/law/breaking_sop_major
	...
	suggested_punishments = "30 minutes to 1 hour of Brig time.  Demotion left to discretion of Superior, but strongly suggested.  Termination at discretion of Commanding Officer."
...
/datum/lore/codex/page/law/neglect_of_duty
	...
	suggested_punishments = "Demotion at discretion of Superior.  Termination at discretion of the Commanding Officer."
	...
	is meant to be applied only by Command staff to their subordinates, and not from individual Guards."

/datum/lore/codex/page/law/deception
	name = "Deception"
	definition = "To lie in an official report."
	suggested_punishments = "Demotion.  Termination at discretion of Commanding Officer.  Notify Central Command."
...
/datum/lore/codex/page/law/abuse_of_confiscated_equipment
	...
	suggested_punishments = "Demotion of the user.  Termination at discretion of Commanding Officer.  Return confiscated equipment to evidence storage."
