...
/datum/lore/codex/page/general_sop
	...
	not registered on the manifest are required to speak with the Executive Officer or Commanding Officer, if one exists, to register, and obtain an identification \
...
/datum/lore/codex/page/command_sop
	name = "Command SOP"
	data = "This SOP is specific to those in the Command department, which includes the Commanding Officer, Executive Officer, Chief Engineer, Head of Operations, and Research Director.  \
	...
	The Chain of Command is generally represented as: Commanding Officer > Command Crew > Station Crew.<br>\
	The Commanding Officer is responsible for, and authoritative in, and and all matters regarding the station.  In the absence of a Department Head, the Commanding Officer \
	...
	is to step down, and the Commanding Officer is to defer to the Department Head in matters involving said department.\
	<br>\
	...
	In the case of the Executive Officer, this includes Service, Cargo, and any other Civilian role.  Command Crew only have authority in their own department, when going \
	...
	or other gross incompetence.  Certain infractions necessitate that a guilty crew member receive a demotion.  Demotion is to be performed by the Executive Officer, or the \
	Commanding Officer, as soon as possible.  The demoted crewmember is to be present during the demotion, unless it is caused by a criminal sentence.  If said crewmemeber \
	refuses to comply with a demotion order, Security is to escort them to the Executive Officer's office.\
	<br>\
	...
	In case of emergency or other need, and in the absence of a Commanding Officer, an Acting Director may be selected from active, certified Command crew.  \
	The selected individual has the same responsibility and authority as a certified Commanding Officer, along with that of their regular position, with the assumption that \
	they will step down if a certified Commanding Officer arrives on station.  This role is entirely voluntary, and no Command crew may be forced into the role \
	if they are opposed to doing so.\
	<br>\
	The preferred order of selecting an Acting Director is as follows:<br>\
	The role is to be offered to the Executive Officer, if one is present.  If there is no Executive Officer, or they are unwilling to assume Acting Director, the \
	position is offered to non-Security Command crew.  If no other Command crew is available or willing to assume Acting Director, the Head of Operations may be offered \
	...
	If a member of the Command crew is suspected to be incompetent, or in breach of SOP, the Commanding Officer has discretion to demote the guilty Command crewmember.  \
	If there is no Commanding Officer, or the Commanding Officer themselves is guilty, they may be demoted after a vote of no confidence by the remaining Command crew \
	and relevant station crew.  For the Commanding Officer, the vote is only to be among the remaining Command crew.  Misuse of this privilage may warrant an \
...
/datum/lore/codex/page/medical_sop
	...
	to as DNC) order in their medical records, or if the individual has had a DNC order declared against them by the Commanding Officer, Chief \
	Medical Officer, or Head of Operations.  If any of this occurs, procede to Portmortem Storage.\
	<br>\
...
/datum/lore/codex/page/science_sop
	...
	Combat exosuits (Durand, Gygax) may not be built without permission from the Head of Operations or Commanding Officer.\
	<br>\
...
/datum/lore/codex/page/green
	...
	only be done with the consent of the searched, or with a signed warrant by the Head of Operations or Commanding Officer.  A warrant is not required \
