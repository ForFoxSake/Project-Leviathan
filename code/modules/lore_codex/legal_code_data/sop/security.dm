...
/datum/lore/codex/page/sop_sec_alert_levels
	...
	Weaponry and specialized armor are allowed to be given out to guards, with clearance from the Warden or Head of Operations.\
	<br>\
	...
	helmets are mandatory.  Specialized armor may be distributed by the Warden and Head of Operations, when appropiate."
