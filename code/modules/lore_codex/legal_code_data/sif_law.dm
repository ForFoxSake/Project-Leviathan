...
/datum/lore/codex/page/law/excessive_force/add_content()
	...
	suggested_punishments = "Demotion.  Termination at discretion of Superior, or Commanding Officer.  Send notice to Central Command if a Head of Operations had used excessive force."
