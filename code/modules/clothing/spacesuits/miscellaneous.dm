...
/obj/item/clothing/suit/armor/captain
	name = "commanding officer's armor"
	...
	allowed = list(/obj/item/weapon/tank/emergency/oxygen, /obj/item/device/lighting,/obj/item/weapon/gun/energy, /obj/item/weapon/gun/projectile, /obj/item/ammo_magazine, /obj/item/ammo_casing, /obj/item/weapon/melee/baton,/obj/item/weapon/handcuffs)
	slowdown = 1.5
	armor = list(melee = 65, bullet = 50, laser = 50, energy = 25, bomb = 50, bio = 100, rad = 50)
