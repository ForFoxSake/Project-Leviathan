...
/obj/item/clothing/under/rank/security/skirt
	name = "guard's jumpskirt"
	desc = "Standard feminine fashion for Guards.  It's made of sturdier material than the standard jumpskirts."
...
/obj/item/clothing/under/rank/head_of_security/skirt
	desc = "It's a fashionable jumpskirt worn by those few with the dedication to achieve the position of \"Head of Operations\". It has additional armor to protect the wearer."
	name = "head of operations' jumpskirt"
	icon_state = "hosf"
	index = 1