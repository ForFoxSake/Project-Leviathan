...
/obj/item/clothing/under/gimmick/rank/captain/suit/skirt
	name = "commanding officer's skirt suit"
...
/obj/item/clothing/under/gimmick/rank/head_of_personnel/suit/skirt
	name = "executive officer's skirt suit"
...
/obj/item/clothing/under/dress/dress_cap
	name = "commanding officer's dress uniform"
	desc = "Feminine fashion for the style conscious Commanding Officer."
	icon_state = "dress_cap"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS

/obj/item/clothing/under/dress/dress_hop
	name = "executive officer dress uniform"
	desc = "Feminine fashion for the style conscious Executive Officer."
...
/obj/item/clothing/under/captainformal
	name = "commanding officer's formal uniform"
	desc = "A Commanding Officer's formal-wear, for special occasions."
	icon_state = "captain_formal"
	item_state_slots = list(slot_r_hand_str = "lawyer_blue", slot_l_hand_str = "lawyer_blue")

/obj/item/clothing/under/hosformalmale
	name = "head of operations' formal uniform"
	desc = "A male head of operations' formal-wear, for special occasions."
	icon_state = "hos_formal_male"
	item_state_slots = list(slot_r_hand_str = "lawyer_red", slot_l_hand_str = "lawyer_red")

/obj/item/clothing/under/hosformalfem
	name = "head of operations' formal uniform"
	desc = "A female head of operations' formal-wear, for special occasions."
