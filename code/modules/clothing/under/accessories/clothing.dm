...
/obj/item/clothing/accessory/poncho/roles/cloak/hop
	...
	desc = "An elaborate cloak meant to be worn by the executive officer."
	icon_state = "hopcloak"
	item_state = "hopcloak"
...
/obj/item/clothing/accessory/poncho/roles/cloak/hos
	name = "head of operations' cloak"
	desc = "An elaborate cloak meant to be worn by the head of operations."
	icon_state = "hoscloak"
	item_state = "hoscloak"

/obj/item/clothing/accessory/poncho/roles/cloak/captain
	name = "commanding officer's cloak"
	desc = "An elaborate cloak meant to be worn by the Commanding Officer."
	icon_state = "capcloak"
	item_state = "capcloak"
