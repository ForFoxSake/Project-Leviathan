...
/obj/item/clothing/suit/fire
	...
	allowed = list(/obj/item/device/lighting,/obj/item/weapon/tank/emergency/oxygen,/obj/item/weapon/extinguisher)
	slowdown = 1.0
...
/obj/item/clothing/suit/radiation
	...
	allowed = list(/obj/item/device/lighting,/obj/item/weapon/tank/emergency/oxygen,/obj/item/clothing/head/radiation,/obj/item/clothing/mask/gas)
	slowdown = 1.5
	armor = list(melee = 0, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 60, rad = 100)
	flags_inv = HIDEJUMPSUIT|HIDETAIL|HIDETIE|HIDEHOLSTER
	item_flags = THICKMATERIAL