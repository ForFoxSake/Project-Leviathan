...
/obj/item/clothing/head/beret/sec/navy/hos
	name = "Head of Operations beret"
	desc = "A navy blue beret with a Head of Operations' rank emblem. For officers that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/sec/corporate/hos
	name = "Head of Operations beret"
	desc = "A corporate black beret with a Head of Operations' rank emblem. For officers that are more inclined towards style than safety."
...
/obj/item/clothing/head/helmet/HoS
	name = "head of operations helmet"
	desc = "Standard Head of Operations gear. Protects the head from impacts."

/obj/item/clothing/head/helmet/HoS/hat
	name = "head of operations hat"
	desc = "The hat of the Head of Operations. For showing the officers who's in charge."
	icon_state = "hoscap"
	valid_accessory_slots = null
