...
/proc/AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, rank)
	...
	if(rank == "Heads")
		...
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Commanding Officer")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Head of Operations")
	...
	if(rank == "Security")
		...
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Guard")
