...
/datum/gear/accessory/holster
	...
	//allowed_roles = list("Commanding Officer", "Executive Officer", "Guard", "Warden", "Head of Operations","Detective")
...
/datum/gear/accessory/brown_vest
	...
	//allowed_roles = list("Station Engineer","Atmospheric Technician","Chief Engineer","Guard","Detective","Head of Operations","Warden","Paramedic","Chief Medical Officer","Medical Doctor", "Search and Rescue")
