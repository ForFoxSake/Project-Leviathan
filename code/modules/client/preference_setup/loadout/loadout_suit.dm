...
/datum/gear/suit/roles/poncho/cloak/hos
	display_name = "cloak, head of operations"
	path = /obj/item/clothing/accessory/poncho/roles/cloak/hos
	allowed_roles = list("Head of Operations")
...
/datum/gear/suit/roles/poncho/cloak/captain
	display_name = "cloak, commanding officer"
...
/datum/gear/suit/roles/poncho/cloak/hop
	display_name = "cloak, executive officer"
...
/datum/gear/suit/wintercoat/captain
	display_name = "winter coat, commanding officer"
...
/datum/gear/suit/wintercoat/security
	...
	allowed_roles = list("Guard", "Head of Operations", "Warden", "Detective")
...
/datum/gear/suit/snowsuit/command
	...
	allowed_roles = list("Commanding Officer","Research Director","Executive Officer","Head of Operations","Chief Engineer","Bridge Officer")
...
/datum/gear/suit/snowsuit/cargo
	...
	allowed_roles = list("Quartermaster","Shaft Miner","Cargo Technician","Executive Officer")
