...
/datum/gear/uniform/dept/undercoat/command
	...
	allowed_roles = list("Commanding Officer","Executive Officer","Head of Operations","Chief Engineer","Chief Medical Officer","Research Director")
...
/datum/gear/uniform/dept/undercoat/security
	...
	allowed_roles = list("Head of Operations","Detective","Warden","Guard")
...
/datum/gear/uniform/dept/undercoat/service
	...
	allowed_roles = list("Executive Officer","Bartender","Botanist","Janitor","Chef","Librarian")
