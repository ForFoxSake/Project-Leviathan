...
/datum/gear/accessory/holster
	...
	//allowed_roles = list("Commanding Officer", "Executive Officer", "Guard", "Warden", "Head of Operations","Detective","Explorer","Pathfinder")

/datum/gear/accessory/brown_vest
	display_name = "webbing, brown"
	//allowed_roles = list("Station Engineer","Atmospheric Technician","Chief Engineer","Guard","Detective","Head of Operations","Warden","Paramedic","Chief Medical Officer","Medical Doctor","Chemist","Field Medic","Explorer","Pathfinder","Shaft Miner")
