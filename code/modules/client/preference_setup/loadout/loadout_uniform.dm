...
/datum/gear/uniform/job_skirt/warden
	...
	allowed_roles = list("Head of Operations", "Warden")
...
/datum/gear/uniform/uniform_captain
	display_name = "uniform, commanding officer's dress"
...
/datum/gear/uniform/corpdetsuit
	...
	allowed_roles = list("Detective","Head of Operations")

/datum/gear/uniform/corpsecsuit
	display_name = "uniform, corporate (Security)"
	path = /obj/item/clothing/under/rank/security/corp
	allowed_roles = list("Guard","Head of Operations","Warden")
...
/datum/gear/uniform/corphossuit
	display_name = "uniform, corporate (Head of Operations)"
	path = /obj/item/clothing/under/rank/head_of_security/corp
	allowed_roles = list("Head of Operations")

/datum/gear/uniform/uniform_hop
	display_name = "uniform, XO's dress"
	path = /obj/item/clothing/under/dress/dress_hop
	allowed_roles = list("Executive Officer")

/datum/gear/uniform/uniform_hr
	display_name = "uniform, HR director (XO)"
...
/datum/gear/uniform/navyhossuit
	display_name = "uniform, navy blue (Head of Operations)"
