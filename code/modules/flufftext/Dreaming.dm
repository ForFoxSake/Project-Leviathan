...
var/list/dreams = list(
	"an ID card","a bottle","a familiar face","a crewmember","a toolbox","a guard","the commanding officer",
	...
	"the executive officer","the head of operations","a chief engineer","a research director","a chief medical officer",
